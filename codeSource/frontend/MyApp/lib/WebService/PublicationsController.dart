...
// to a giving a publication
  ...
  static Future<bool> approvePublication(
      String publicationId, bool isApproved, String approvedBy) async {
    print(
        "approve Publication that been sended is ... to pub : $publicationId");
    String token = await storage.read(key: 'token');
